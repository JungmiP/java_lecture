...
public class BaseballGameUtil2 {
	...
	int[] inputThreeNums(int[] answers) {
		int[] nums = new int[3];
	...
	// 게임 진행 메소드
	void progressGame(int[] answers){
		int outCnt = 0, chance = 6;
		
		do {
			int[] chkResult = inputThreeNums(answers);
			chance--;
			outCnt += chkResult[2];			
